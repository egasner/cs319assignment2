    ...
    return (
      <div className="flex fixed flex-row">
        ...
        <div className="px-6 py-4">
          ...
          by - <b style={{ color: 'orange' }}>Ethan Gasner and Savannah Franklin</b>
          </p>
          <div className="py-10">
          ...
          <div className="py-10">
              <input type="search" value={query} onChange={handleChange} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
          </div>
